...
export const GIFT_TIERS: GiftTier[] = [
  ...
  },
  {
    ...
    examples: '热气球 / 浪漫马车',
    serviceName: '故人签',
    serviceDesc: '古人处境镜：从十人签池随机拈一位（苏轼/王阳明/司马迁/曾国藩……），看他在比你难得多的处境里如何自处',
    plainDesc: '让一位古人做你的镜子：他在比你难得多的处境里是怎么站住的——看别人的局，破自己的局',
    displaySeconds: 18,
    perks: ['古人处境卡 ×1（十人签池随机）', '含处境史实 + 镜问', '上屏展示 18 秒', '主播口播致谢'],
  },
  {
    id: 't4',
    name: '典藏礼',
    ...
    examples: '火箭 / 嘉年华',
    serviceName: '观心签',
    serviceDesc: '断语叙事练习卡：从八套标签练习随机拈一套（「我这人就这样」「我命不好」……），三问一次完整的自我整理',
    plainDesc: '一面只照你自己的镜子：你为什么相信这个标签？它替你关上了哪些门——三问下来，一次完整的自我整理',
    displaySeconds: 30,
    perks: ['叙事练习卡 ×1（八套随机）', '三问完整练习', '上屏展示 30 秒', '主播口播致谢', '名字入当周「知音榜」'],
  },
];
