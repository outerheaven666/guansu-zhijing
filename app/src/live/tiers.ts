...
export const GIFT_TIERS: GiftTier[] = [
  {
    ...
    examples: '小心心 / 玫瑰 / 啤酒',
    serviceName: '节气卡',
    serviceDesc: '当令节气文化卡：昵称入卡，主角区按昵称生成「镜语·功课·雅趣」三行（三大独立内容池，约 2.2 万种组合，一人一张）',
  ...
  },
  {
    ...
    examples: '你真好看 / 墨镜',
    serviceName: '执镜卡',
    serviceDesc: '经典引文卡：按本周直播主题，取一条庄子/道德经/孙子/毛选/阴符经原文，附出处、镜问与小实验',
    plainDesc: '从庄子、道德经、孙子、毛选、阴符经里为你拈一面镜子：不给答案，只帮你把当下这团乱麻照清楚',
    displaySeconds: 18,
    perks: ['专属昵称引文卡 ×1', '含出处 + 镜问 + 小实验', '上屏展示 18 秒'],
  },
  {
    id: 't3',
    name: '高阶礼',
    ...
    examples: '热气球 / 浪漫马车',
    serviceName: '故人卡',
    serviceDesc: '古人处境镜：从十六人池随机取一位（苏轼/王阳明/张骞/徐霞客……），看他在比你难得多的处境里如何自处',
    plainDesc: '让一位古人做你的镜子：他在比你难得多的处境里是怎么站住的——看别人的局，破自己的局',
    displaySeconds: 23,
    perks: ['古人处境卡 ×1（十六人池随机）', '含处境史实 + 镜问', '上屏展示 23 秒', '主播口播致谢'],
  },
  {
    id: 't4',
    name: '典藏礼',
    ...
    examples: '火箭 / 嘉年华',
    serviceName: '观心卡',
    serviceDesc: '断语叙事练习卡：从十二套标签练习随机取一套（「我这人就这样」「贵人还没到」……），三问一次完整的自我整理',
    plainDesc: '一面只照你自己的镜子：你为什么相信这个标签？它替你关上了哪些门——三问下来，一次完整的自我整理',
    displaySeconds: 30,
    perks: ['叙事练习卡 ×1（十二套随机）', '三问完整练习', '上屏展示 30 秒', '主播口播致谢', '名字入当周「知音榜」'],
  },
];
